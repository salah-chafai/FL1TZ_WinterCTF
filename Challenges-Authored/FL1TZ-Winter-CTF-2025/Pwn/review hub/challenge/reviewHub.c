...
void process_employee_reviews() {
    ...
    for (i = 0; i < 5; i++) {
        ...
        snprintf(review_prompt, sizeof(review_prompt), COLOR_BLUE "Review %d of %d: Log details for employee performance (up to 256 characters): " COLOR_RESET, i + 1, 5);
